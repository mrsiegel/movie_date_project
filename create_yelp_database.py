...
# This function calls cityInfo and inputs the data into the table, Top20BusinessesinCities, if it is not already there
dbname = "final_project_yelp.db"
...
def insert_yelp_data1():
    ...
    conn = sqlite3.connect('final_project_yelp.db')
    cur = conn.cursor()
